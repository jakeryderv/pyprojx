...
`[build-system]` lack, and checks `[tool.ruff]` options, values, and rule selectors
against the Ruff versions the project allows. The other capabilities above are not implemented
yet.
